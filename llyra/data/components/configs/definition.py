...
class ConfigData:
    ...
    Args:
        model: A `str` indicates the name of the model used for inference.
        strategy: A `Path` instance indicates the path to 
    ...
    model: str
    strategy: Path
    local: LocalConfigData | False
    remote: RemoteConfigData | False